...
app.get('/', (req, res) => {
    ...
    let createquery = "CREATE TABLE IF NOT EXISTS ?? (ID int NOT NULL AUTO_INCREMENT,State_Name VARCHAR(255), Date_of_Record date,No_of_Samples int(11),No_of_Deaths int(11),No_of_Positive int(11),No_of_Negative int(11),No_of_Discharge int(11),PRIMARY KEY (ID))"
    ...
    // let insertQuery = "Insert into ?? (State_Name, Date_of_Record, No_of_Samples,No_of_Deaths,No_of_Positive,No_of_Negative,No_of_Discharge) values ('kerala','2018-10-20',12,8,5,3,2)";
...
app.post('/save', (req, res) => {
    let data = {
        ...
        No_of_Deaths: req.body.No_of_Deaths,
...
app.post('/update', (req, res) => {
    ...
    let sql = "update ?? SET State_Name='"+req.body.State_Name+"',  Date_of_Record='"+req.body.Date_of_Record+"',  No_of_Samples='"+req.body.No_of_Samples+"',No_of_Deaths='"+req.body.No_of_Deaths+"',No_of_Positive='"+req.body.No_of_Positive+"',No_of_Negative='"+req.body.No_of_Negative+"',No_of_Discharge='"+req.body.No_of_Discharge+"' where id ="+ID;;
